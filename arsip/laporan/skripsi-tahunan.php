...
INNER JOIN tb_kategori ON tb_skripsi.id_kategori=tb_kategori.id_kategori WHERE tb_skripsi.tahun='$_POST[tahun]' ");
...
<!-- <center>
	<img src="../_assets/images/ptik.png" width="70">
		...
		<h3>LAPORAN DATA JUDUL SKRIPSI ANGKATAN <?php echo $ds['tahun']; ?><br>JURUSAN PENDIDIKAN TEKNIK INFORMATIKA DAN KOMPUTER <br> FAKULTAS TARBIYAH DAN ILMU KEGURUAN (FTIK) <br> INSTITUT AGAMA ISLAM NEGERI (IAIN) <br> BUKITTINGGI</h3></center> -->
