          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Data Jurnal Mahasiswa</h5>
                <ol class="breadcrumbs">
                    <li><a href="">Jurnal</a></li>
                    <li class="active">Lihat Jurnal Skripsi</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="section">
            <div class="card-panel">
                ...
                <div class="col s12 m8 l9">
                    <h4 class="header">Data Judul Jurnal Mahasiswa </h4>
          ...
          <!-- Floating Action Button -->
            <div class="fixed-action-btn" style="bottom: 50px; right: 19px;">
                ...
                <a href="javascript:history.back()" class="btn tooltipped btn-floating btn-large" data-position="left" data-delay="50" data-tooltip="Kembali">
                  ...
                  <a href="?page=jurnal" class="btn tooltipped btn-floating btn-large waves-effect waves-light green" data-position="top" data-delay="50" data-tooltip="Tambah Data">
