            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumbs">
                    ...
                    <li class="active">Tambah Data Fakultas</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 class="header2">Form Tambah Data Fakultas</h4>
                <div class="row">
                  <form class="col s12" action="?page=proses" method="POST" enctype="multipart/form-data">
                    <div class="row">
                      <div class="input-field col s12">
                        <input name="fakultas" id="fakultas" type="text">
                    ...
                    <div class="row">
                      <div class="row">
                        <div class="input-field col s12">
                          <button class="btn cyan waves-effect waves-light" type="submit" name="S-Fak">Simpan
