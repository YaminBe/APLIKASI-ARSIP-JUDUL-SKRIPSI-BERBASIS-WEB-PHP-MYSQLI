          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 class="header2">Form Edit Data Kategori</h4>
                <div class="row">
                        <?php 
                  $id= $_GET['id'];
                  ...
                  <form class="col s12" action="?page=proses" method="POST" enctype="multipart/form-data">
                    <div class="row">
                      <div class="input-field col s12">
                        <input name="id" type="hidden" value="<?php echo $data['id_kategori'] ?>">
                        <input name="kategori" id="kategori" type="text" value="<?php echo $data['kategori'] ?>">
                    ...
                    <div class="row">
                      <div class="row">
                        <div class="input-field col s12">
                          <button class="btn cyan waves-effect waves-light" type="submit" name="E-Kat">Simpan
