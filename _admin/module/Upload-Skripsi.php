          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 class="header2">Form Upload File Skripsi</h4>
                <div class="row">
                  <form class="col s12" action="" method="POST" enctype="multipart/form-data">
                  	<div class="row">
                      <div class="input-field col s12">
                        <select name="id_skripsi">
                          <option value="" selected>- Pilih Judul Skripsi-</option>
                            <?php
                            $sqlGuru=mysqli_query($con, "SELECT * FROM tb_skripsi ORDER BY id_skripsi ASC");
                            while($g=mysqli_fetch_array($sqlGuru)){
                            echo "<option value='$g[id_skripsi]'>$g[judul]</option>";
                            }
                            ?>
                        </select>
...
$lokasi = '../file/'.$id_skripsi.'.'.$file_ext;
move_uploaded_file($file_tmp, $lokasi);
$in = mysqli_query($con,"INSERT INTO tb_fileskripsi (

	id_file,id_skripsi,tanggal_upload,tipe_file,ukuran_file,file) VALUES(NULL,'$id_skripsi','$tgl','$file_ext', '$file_size', '$lokasi')");
if($in){
