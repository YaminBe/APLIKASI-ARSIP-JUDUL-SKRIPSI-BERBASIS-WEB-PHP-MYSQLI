          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 class="header2">Form Tambah Data Dosen</h4>
                <div class="row">
                  <form class="col s12" action="?page=proses" method="POST" enctype="multipart/form-data">
                    <div class="row">
                     ...
                     <div class="row">
                      <div class="input-field col s6">
                        ...
                        <div class="input-field col s6">
                        <input name="gelar" id="gelar" type="text">
                    ...
                    <div class="row">
                      <div class="row">
                        <div class="input-field col s12">
                          <button class="btn cyan waves-effect waves-light right" type="submit" name="S-dsn">Simpan
