                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <?php 
                              if ($d['aktif']=='Y') {
                                  echo '<b style="background-color: green;color: #fff;padding: 5px;border-radius: 10px;">Aktif</b>';
                              }else{
                                echo '<b style="background-color: red;color: #fff;padding: 5px;border-radius: 10px;">Non Aktif</b>';
                             }
                                ?>
