                  ...
                  <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="?page=dsn-detail&id=<?php echo $data['id_dosen'];?> " class="btn tooltipped waves-effect waves-light btn" data-position="left" data-delay="50" data-tooltip="Preview Data / Detail">
                                    <!-- <i class="mdi-action-find-in-page"></i>  -->Preview </a>
                        <!-- <a href="?page=dsn-detail&id=<?php echo $data['id_dosen'];?> " class="btn tooltipped btn tooltipped waves-effect waves-light btn" data-position="left" data-delay="50" data-tooltip="Edit Data"><i class="mdi-action-find-in-page"></i></a>  -->
                            </td>
                        </tr>
                        <?php
                         }
